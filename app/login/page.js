    ...
    return (
        <div className='text-white py-14 container mx-auto'>
            ...
            <div className="flex flex-col gap-5 items-center min-h-screen p-10 ">
                ...
                <button
                    className="flex items-center bg-slate-900 border border-gray-300 w-80 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 focus:outline-none  hover:text-black active:scale-95 active:shadow-inner transition duration-150 ease-in-out">
                ...
                <button
                    className="flex items-center bg-slate-900 border border-gray-300 w-80 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-200 active:scale-95 active:shadow-inner transition duration-150 ease-in-out hover:text-black">
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
